namespace CCOF.Infrastructure.WebAPI.Models
{
    public class DataverseSearch
    {
        ...
        public string? filter { get; } = "account:ccof_accounttype eq 100000001,ccof_facilitystatus ne 100000009"; // Restrict Search to Facility account type and excluding closed status
