namespace CCOF.Infrastructure.WebAPI.Models
{
    public class DataverseSearch
    {
        ...
        public string? filter { get; } = "account:ccof_accounttype eq 100000001,ccof_facilitystatus eq 100000001"; // Restrict Search to Facility account type with approved status only
