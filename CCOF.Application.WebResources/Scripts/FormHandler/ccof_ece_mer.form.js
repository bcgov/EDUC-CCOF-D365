...
var CCOF = CCOF || {};
CCOF.MonthlyECEReport = CCOF.MonthlyECEReport || {};
CCOF.MonthlyECEReport.Form = CCOF.MonthlyECEReport.Form || {};

CCOF.MonthlyECEReport.Form = {
...
function enableFieldsBasedOnSecurityRole(executionContext) {
    var enableFields = ["statuscode", "ccof_internal_summary"];    // target field(s)
