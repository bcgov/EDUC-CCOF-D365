function hideCalculateCost(primaryControl) {
	...
	var flagLockUnlockValue = formContext.getAttribute("ccof_flaglockunlockinitialand24monthsadjrecord").getValue();
	if ((CCFRIFacilityStatus == 6 || CCFRIFacilityStatus == 7 || CCFRIFacilityStatus == 8 || CCFRIFacilityStatus == 13) && (flagLockUnlockValue == 0)) {
		...
		formContext.getControl("ccof_meficap24month").setDisabled(true);
		formContext.getControl("ccof_limitfeestonmfbenchmark_24month").setDisabled(true);
		formContext.getControl("ccof_reachedcaps_24month").setDisabled(true);
		return false; //Hide Calculate Costs Button
	}
	else {
		formContext.ui.controls("ccof_meficap").setDisabled(false);
		...
		formContext.getControl("ccof_meficap24month").setDisabled(false);
		formContext.getControl("ccof_limitfeestonmfbenchmark_24month").setDisabled(false);
		formContext.getControl("ccof_reachedcaps_24month").setDisabled(false);
...
//var flowUrl;
// flowUrl = "https://prod-01.canadacentral.logic.azure.com:443/workflows/828029680b9f4a648413271fa9a8c564/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=XU2gfEp6Whz84MPJJP5XhVfA15OLwmia4zsWssSL-Ec"
