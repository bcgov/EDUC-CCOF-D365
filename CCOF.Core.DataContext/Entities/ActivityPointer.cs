...
namespace DataverseModel
{
	...
	public partial class ActivityPointer : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// N:1 ccof_adjudication_ccfri_ActivityPointers
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_adjudication_ccfri_ActivityPointers")]
		public DataverseModel.CcOf_Adjudication_CcFri CcOf_Adjudication_CcFri_ActivityPointers
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.CcOf_Adjudication_CcFri>("ccof_adjudication_ccfri_ActivityPointers", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.CcOf_Adjudication_CcFri>("ccof_adjudication_ccfri_ActivityPointers", null, value);
			}
		}
		
		/// <summary>
		/// N:1 ccof_ccfri_email_ActivityPointers
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_ccfri_email_ActivityPointers")]
		public DataverseModel.CcOf_CcFri_Email CcOf_CcFri_Email_ActivityPointers
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.CcOf_CcFri_Email>("ccof_ccfri_email_ActivityPointers", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.CcOf_CcFri_Email>("ccof_ccfri_email_ActivityPointers", null, value);
			}
		}
		
		/// <summary>
		/// N:1 ccof_change_request_mtfi_ActivityPointers
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_change_request_mtfi_ActivityPointers")]
		public DataverseModel.CcOf_Change_Request_MTfI CcOf_Change_Request_MTfI_ActivityPointers
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.CcOf_Change_Request_MTfI>("ccof_change_request_mtfi_ActivityPointers", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.CcOf_Change_Request_MTfI>("ccof_change_request_mtfi_ActivityPointers", null, value);
			}
		}
