...
namespace DataverseModel
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// 1:N ccof_business_bceid_organization
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_business_bceid_organization")]
		public System.Collections.Generic.IEnumerable<DataverseModel.CcOf_BcEId_Organization> CcOf_Business_BcEId_Organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.CcOf_BcEId_Organization>("ccof_business_bceid_organization", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.CcOf_BcEId_Organization>("ccof_business_bceid_organization", null, value);
			}
		}
		
		/// <summary>
		/// 1:N ccof_change_action_closure_request_raised_by_contact
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_change_action_closure_request_raised_by_contact")]
		public System.Collections.Generic.IEnumerable<DataverseModel.CcOf_Change_Action_Closure> CcOf_Change_Action_Closure_Request_Raised_By_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.CcOf_Change_Action_Closure>("ccof_change_action_closure_request_raised_by_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.CcOf_Change_Action_Closure>("ccof_change_action_closure_request_raised_by_contact", null, value);
			}
		}
		
		/// <summary>
		/// 1:N ccof_funding_agreement_sp_primary_contact_name_contact
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ccof_funding_agreement_sp_primary_contact_name_contact")]
		public System.Collections.Generic.IEnumerable<DataverseModel.CcOf_Funding_Agreement> CcOf_Funding_Agreement_Sp_Primary_Contact_Name_Contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.CcOf_Funding_Agreement>("ccof_funding_agreement_sp_primary_contact_name_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.CcOf_Funding_Agreement>("ccof_funding_agreement_sp_primary_contact_name_contact", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.Account> OfM_Contact_Account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.Account>("ofm_contact_account", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.Account>("ofm_contact_account", null, value);
			}
		}
		...
		public DataverseModel.BusinessUnit Business_Unit_Contacts
		{
			...
			set
			{
				this.SetRelatedEntity<DataverseModel.BusinessUnit>("business_unit_contacts", null, value);
			}
		}
